...
docker run --init -it --rm efrecon/mqtt-client sh -c "pub -h debian.fritz.box -t 'devices/083af2514ee8/\$update' -m true ; sub -h debian.fritz.box -t 'devices/083af2514ee8/\$state' -C 3 -R -v"
