...
scp "$PWD/build/1602RawIdf.bin" root@debian.fritz.box:/tmp/esp32
...
docker run --init -it --rm --entrypoint sh efrecon/mqtt-client -c "pub -h debian.fritz.box -t 'devices/083af2514ee8/\$update' -m true ; sub -h debian.fritz.box -t 'devices/083af2514ee8/\$state' -C 3 -R -v"
